      ...
      body: Center(
        child: Column(
          children: [
            ...
            Text(
              'Welcome to the',
              style: TextStyle(fontFamily: 'Manjari', fontSize: 32),
            ),
            Text(
              'TripSeat',
              style: TextStyle(
            ...
            Padding(
              ...
              child: Image.asset(
                'assets/images/sign_in_bottom.png',
                width: double.infinity,
                fit: BoxFit.fill,
              ),
            ),
            greyLaterButton('Start without setting', () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => ChooseInterestScreen()),
              );
            }),
            SizedBox(height: 12),
            greenNextButton('Set preferences', () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => ChooseInterestScreen()),
              );
